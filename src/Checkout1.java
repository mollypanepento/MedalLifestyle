...
/**
 * .java is a 1.4 application that uses these additional files:
 * SpringUtilities.java ...
 */
public class Checkout1 extends JPanel implements ActionListener, FocusListener {
	JTextField emailField, fNameField, lNameField, streetField, cityField, stateField;
	JFormattedTextField zipField;
	boolean addressSet = false;
	Font regularFont, italicFont;
	JLabel addressDisplay, cart, info, pay;
...
//		contentPaneHeart.add(pay);
		leftHalf.add(cart, BorderLayout.LINE_START);
		leftHalf.add(info, BorderLayout.CENTER);
		leftHalf.add(pay, BorderLayout.LINE_END);
	...
	protected JComponent createEntryFields() {
		...
		String[] labelStrings = { "Email: ", "First Name: ", "Last Name: ","Street address: ", "City: ", "State: ", "Zip code: ", "Phone Number: " };
		...
		fields[fieldNum++] = fNameField;
		
		lNameField = new JTextField();
		lNameField.setColumns(20);
		fields[fieldNum++] = lNameField;
	...
	private static void createAndShowGUI() {
		...
		JComponent newContentPane = new Checkout1();
